...
M.sql_extractor = require('cmd.jdbcmap.sql_extractor')
M.column_parser = require('cmd.jdbcmap.column_parser')
M.table_analyzer = require('cmd.jdbcmap.table_analyzer')
M.param_extractor = require('cmd.jdbcmap.param_extractor')
M.mapper = require('cmd.jdbcmap.mapper')
M.report_generator = require('cmd.jdbcmap.report_generator')
M.constant_extractor = require('cmd.jdbcmap.constant_extractor')
